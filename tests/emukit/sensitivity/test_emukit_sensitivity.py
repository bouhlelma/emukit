...
def test_model_based_montecarlo_sensitivity(model):
    ...
    main_sample = np.array([[3.10732573, -1.25504469, -2.66820221], [-1.32105416, -
                                                                     1.45224686, -2.06642419], [2.41144646, -1.98949844, 1.66646315]])
    fixing_sample = np.array([[-2.93034587, -2.62148462, 1.71694805], [-2.70120457,
                                                                       2.60061313, 3.00826754], [-2.56283615, 2.53817347, -1.00496868]])
...
def test_montecarlo_sensitivity():
    ...
    main_effects, total_effects, total_variance = sensitivity_ishigami.compute_effects(
        main_sample=main_sample, fixing_sample=fixing_sample, num_monte_carlo_points=num_mc)
